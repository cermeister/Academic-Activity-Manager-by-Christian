...
function App() {
  ...
  return <div className={`app ${mobileNavOpen ? "navOpen" : ""} ${isViewer ? "viewerMode" : ""}`}>
    ...
    <main>
      {!isViewer && <button className="workspaceReturn" onClick={() => {setManagedAccount(""); setSelected("dashboard"); setModal(null); setQuery("");}}><ArrowRight size={16}/>{managedAccount ? "Back to admin workspace" : "Admin workspace"}</button>}
