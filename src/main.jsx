...
function App() {
  ...
  return <div className="app">
    ...
    {modal && <Modal data={modal} subjects={subjects} onSaveSubject={saveSubject} onSaveItem={saveItem} close={() => setModal(null)}/>} 
  </div>;
}
