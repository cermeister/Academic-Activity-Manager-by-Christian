...
function LoginWithAccounts({logo, onLogin}) {
  ...
  return <div className="loginPage">
    ...
    <main className="loginMain"><div className="loginCard">
      ...
      <p className="loginHelp"><BookOpen size={16}/> Do you want to have your own? Contact Christian Cervantes.</p><div className="loginTip"><CheckCircle2 size={21}/><span>Portfolio:<br/><a href="https://cermeister.netlify.app/">Christian Cervantes</a></span></div>
    </div></main>
  </div>;
}
